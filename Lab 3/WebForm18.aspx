<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm18.aspx.cs" Inherits="Lab_3.WebForm18" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table align="center" style="width: 50%; background-color: #FF66CC">
           ...
           <td class="modal-sm" style="width: 153px">&nbsp;</td>
            ...
            <td class="modal-sm" style="width: 401px">&nbsp;</td>
             ...
             <td class="modal-sm" style="width: 153px; text-align: center;"><strong>
                <asp:Label ID="Label1" runat="server" Text="Username" Style="color: #000000"></asp:Label>
                :</strong></td>
            <td style="width: 131px">
        ...
        <tr>
            <td class="modal-sm" style="width: 153px; text-align: center; color: #000000;"><strong>
...
PreferredPasswordLength="10" MinimumNumericCharacters="1" MinimumSymbolCharacters="1" PrefixText="Strength :  "/>
            ...
            &nbsp;<asp:Label ID="Label6" runat="server"></asp:Label>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txtP3" ErrorMessage=" " ValidationExpression="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,10}$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
